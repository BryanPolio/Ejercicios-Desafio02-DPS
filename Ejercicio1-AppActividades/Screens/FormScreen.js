...
export default function FormScreen({ navigation, route }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TextInput placeholder="Fecha de entrega (DD-MM-YYYY)" style={styles.input} value={fecha} onChangeText={setFecha} />
      <Button title={actividadEdit ? "Actualizar actividad" : "Guardar actividad"} onPress={guardarActividad} color="#a47551" />
    </ScrollView>
  );
}
